    <?php require APP_ROOT . '/app/views/components/loading/loading.php'; ?>
    ...
    <script src="<?= asset('js/ts/app.js') ?>"></script>
    <script src="<?= asset('js/ts/features/account-profile.js') ?>"></script>
    <script src="<?= asset('js/ts/features/table-filter.js') ?>"></script>
    <?php
    ...
    if (str_contains($currentScript, '/views/senior-houseparent/')) $autoScripts[] = 'senior-houseparent.js';
