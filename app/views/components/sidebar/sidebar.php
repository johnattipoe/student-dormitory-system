    ...
    <div class="sidebar-inner d-flex flex-column h-100">
        ...
        if ($role === ROLE_ADMIN) {
            ...
            $adminFeatureItems = [
                ...
                [
                    ...
                    'label' => 'Finance',
                    'href' => url('views/admin/finance/index/index.php'),
        ...
        if (in_array($role, [ROLE_HOUSE_MASTER, ROLE_HOUSE_MISTRESS], true)) {
            $houseMasterFeatureItems = [
                ['icon' => 'bi-mortarboard', 'label' => 'Students', 'href' => 'views/house-master/students/index/index.php', 'section' => 'Management'],
                ['icon' => 'bi-calendar-check', 'label' => 'Attendance', 'href' => 'views/house-master/attendance/index/index.php', 'section' => 'Management'],
                ['icon' => 'bi-door-closed', 'label' => 'Rooms', 'href' => 'views/house-master/rooms/index/index.php', 'section' => 'Management'],
                ['icon' => 'bi-people', 'label' => 'Visitors', 'href' => 'views/house-master/visitors/index/index.php', 'section' => 'Management'],
                ['icon' => 'bi-flag', 'label' => 'Incidents', 'href' => 'views/house-master/incidents/index/index.php', 'section' => 'Management'],
                ...
                ['icon' => 'bi-person-circle', 'label' => 'Profile', 'href' => url('views/house-master/profile/index.php'), 'section' => 'Administration'],
            ];
        ...
        if ($role === ROLE_SENIOR_HOUSEPARENT) {
            $seniorHouseparentFeatureItems = [
                ['icon' => 'bi-mortarboard', 'label' => 'Students', 'href' => 'views/senior-houseparent/students/index/index.php', 'section' => 'Management'],
                ['icon' => 'bi-calendar-check', 'label' => 'Attendance', 'href' => 'views/senior-houseparent/attendance/index/index.php', 'section' => 'Management'],
                ['icon' => 'bi-door-open', 'label' => 'Rooms', 'href' => 'views/senior-houseparent/rooms/index/index.php', 'section' => 'Management'],
                ['icon' => 'bi-people', 'label' => 'Visitors', 'href' => 'views/senior-houseparent/visitors/index/index.php', 'section' => 'Management'],
                ['icon' => 'bi-shield-exclamation', 'label' => 'Incidents', 'href' => 'views/senior-houseparent/incidents/index/index.php', 'section' => 'Management'],
                ...
                ['icon' => 'bi-person-circle', 'label' => 'Profile', 'href' => url('views/senior-houseparent/profile/index.php'), 'section' => 'Administration'],
            ];
        ...
        if ($role === ROLE_NURSE) {
            $nurseFeatureItems = [
                ...
                ['icon' => 'bi-person-circle', 'label' => 'Profile', 'href' => url('views/nurse/profile/index.php'), 'section' => 'Administration'],
            ];
        ...
        if ($role === ROLE_SECURITY) {
            $securityFeatureItems = [
                ...
                ['icon' => 'bi-person-circle', 'label' => 'Profile', 'href' => url('views/security/profile/index.php'), 'section' => 'Administration'],
            ];
        ...
        if ($role === ROLE_STUDENT) {
            $studentFeatureItems = [
                ...
                ['icon' => 'bi-person-vcard', 'label' => 'Account Overview', 'href' => 'views/student/settings/account/index.php', 'section' => 'Administration'],
                ['icon' => 'bi-person-circle', 'label' => 'Profile', 'href' => url('views/student/profile/index/index.php'), 'section' => 'Administration'],
            ];
