...
if (!class_exists(\App\Services\ActivityLogService::class, false)) {
    require_once __DIR__ . '/../ActivityLogService/ActivityLogService.php';
}

if (!class_exists(\App\Services\FirebaseAuthService::class, false)) {
    require_once __DIR__ . '/../FirebaseAuthService/FirebaseAuthService.php';
}

if (!class_exists(\App\Services\FirebaseService::class, false)) {
    require_once __DIR__ . '/../FirebaseService/FirebaseService.php';
}
...
class AuthService
{
    ...
    {
        $config = require APP_ROOT . '/app/config/app/app.php';
