...
class IncidentController
{
    ...
    public function create(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            include __DIR__ . '/../../../public/views/incidents/create/create.php';
            return;
        }
        ...
        redirect(
            base_url('index.php?route=/views/incidents/index/index.php')
        );
    }
    ...
    public function view(): void
    {
        ...
        include __DIR__ . '/../../../public/views/incidents/view/view.php';
    }
    ...
    public function history(): void
    {
        ...
        include __DIR__ . '/../../../public/views/incidents/history/history.php';
    }
}