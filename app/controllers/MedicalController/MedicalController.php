...
class MedicalController
{
    ...
    public function create(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            include __DIR__ . '/../../../public/views/medical/create/create.php';
            return;
        }
        ...
        redirect(
            base_url('index.php?route=/views/medical/index/index.php')
        );
    }
    ...
    public function edit(): void
    {
        ...
        include __DIR__ . '/../../../public/views/medical/edit/edit.php';
    }
    ...
    public function view(): void
    {
        ...
        include __DIR__ . '/../../../public/views/medical/view/view.php';
    }
    ...
    public function reports(): void
    {
        ...
        include __DIR__ . '/../../../public/views/medical/reports/reports.php';
    }
}