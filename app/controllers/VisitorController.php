...
class VisitorController
{
    ...
    public function index(): void
    {
        ...
        include __DIR__ . '/../../public/views/visitors/index.php';
    }

    public function register(): void
    {
        require_role(ROLE_SECURITY, ROLE_HOUSEPARENT, ROLE_HOUSE_MISTRESS);

        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            include __DIR__ . '/../../public/views/visitors/register.php';
            return;
        }
        ...
        if (!empty($errors)) {
            ...
            redirect(
                base_url('index.php?route=/views/visitors/register.php')
            );
        }
        ...
        redirect(
            base_url('index.php?route=/views/visitors/index.php')
        );
    }
    ...
    public function request(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            include __DIR__ . '/../../public/views/visitors/request.php';
            return;
        }
        ...
        if (!empty($errors)) {
            ...
            flash('error', 'Please fix the highlighted fields.');
            redirect(
                base_url('index.php?route=/views/visitors/request.php')
            );
        }
    ...
    public function history(): void
    {
        ...
        include __DIR__ . '/../../public/views/visitors/history.php';
    }
}