...
class RoomController
{
    ...
    {
        require_role(ROLE_ADMIN, ROLE_HOUSE_MASTER, ROLE_HOUSE_MISTRESS, ROLE_HOUSEPARENT);

        $rooms = $this->roomService->all();

        include __DIR__ . '/../../public/views/rooms/index.php';
    }
    ...
    public function create(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            include __DIR__ . '/../../public/views/rooms/create.php';
            return;
        }
        ...
        redirect(
            base_url('index.php?route=/views/rooms/index.php')
        );
    }
    ...
    public function edit(): void
    {
        ...
        include __DIR__ . '/../../public/views/rooms/edit.php';
    }
    ...
    public function allocation(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            redirect(
                base_url('index.php?route=/views/rooms/allocation.php')
            );
        }

        $rooms = $this->roomService->available();

        include __DIR__ . '/../../public/views/rooms/allocation.php';
    }
    ...
    public function occupancy(): void
    {
        ...
        include __DIR__ . '/../../public/views/rooms/occupancy.php';
    }
}