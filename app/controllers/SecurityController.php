...
class SecurityController
{
    ...
    public function visitors(): void
    {
        ...
        include __DIR__ . '/../../public/views/security/visitors/visitors.php';
    }
    ...
    public function registerVisitor(): void
    {
        ...
        redirect(
            base_url('index.php?route=/views/security/visitors/visitors.php')
        );
    }
    ...
    public function incidents(): void
    {
        ...
        include __DIR__ . '/../../public/views/security/incidents/incidents.php';
    }
    ...
    public function reportIncident(): void
    {
        ...
        redirect(
            base_url('index.php?route=/views/security/incidents/incidents.php')
        );
    }
}
