...
class UserController
{
    ...
    public function create(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            include __DIR__ . '/../../public/views/admin/users/create.php';
            return;
        }
        ...
        redirect(
            base_url('index.php?route=/views/admin/users/index.php')
        );
    }
    ...
    public function edit(): void
    {
        ...
        include __DIR__ . '/../../public/views/admin/users/edit.php';
    }
