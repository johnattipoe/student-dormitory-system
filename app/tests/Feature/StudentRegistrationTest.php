...
namespace PHPUnit\Framework {
    if (!class_exists(__NAMESPACE__ . '\\TestCase', false)) {
        abstract class TestCase
        {
            ...
            {
                if (!$condition) {
                    throw new \RuntimeException('Failed asserting that the condition is true.');
                }
            }
            ...
            {
                if ($condition) {
                    throw new \RuntimeException('Failed asserting that the condition is false.');
                }
            }
        }
    }
...
namespace App\Tests\Feature {
    ...
    // @intelephense-ignore - PHPUnit is installed as a dev dependency
