...
if (!defined('ROLE_SENIOR_HOUSEPARENT')) {
    define('ROLE_SENIOR_HOUSEPARENT', 'senior-houseparent');
}
...
$baseRoles = [
    ROLE_ADMIN, ROLE_HOUSE_MASTER, ROLE_HOUSE_MISTRESS, ROLE_SENIOR_HOUSEPARENT,
...
define('PERMISSION_NONE', 'none');
define('PERMISSION_LIMITED', 'limited');
