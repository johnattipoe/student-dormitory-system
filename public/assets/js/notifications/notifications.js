...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const notificationRoutes = {
    admin: '/views/admin/notifications/index/index.php',
    'house-master': '/views/house-master/notifications/index.php',
    houseparent: '/views/senior-houseparent/notifications/index.php',
  ...
  const notificationUrl = roleMatch ? notificationRoutes[roleMatch[1]] : '/views/admin/notifications/index/index.php';
