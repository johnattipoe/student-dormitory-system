...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'check_overstays') {
    ...
    redirect(url('views/security/visitors/overstay-alerts/overstay-alerts.php'));
}
...
$navItems = [
    ...
    ['icon' => 'bi-exclamation-triangle', 'label' => 'Overstay Alerts', 'href' => url('views/security/visitors/overstay-alerts/overstay-alerts.php'), 'active' => true],
];
