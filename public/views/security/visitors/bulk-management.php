...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'bulk_check_in' && !empty($visitorIds)) {
        try {
            ...
            redirect(url('views/security/visitors/bulk-management.php'));
        } catch (Exception $e) {
...
$navItems = [
    ...
    ['icon' => 'bi-arrow-repeat', 'label' => 'Bulk Management', 'href' => url('views/security/visitors/bulk-management.php'), 'active' => true],
];
