    ...
    <div class="content-wrapper">
        <section class="security-hero mb-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a class="btn btn-warning" href="<?= url('views/security/visitors/edit.php?id=' . urlencode($id)) ?>">
            ...
            <div class="col-lg-4">
                ...
                <div class="security-side-card mt-4">
                    ...
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-primary" href="<?= url('views/security/visitors/edit.php?id=' . urlencode($id)) ?>">Update visitor</a>
                        <a class="btn btn-outline-danger" href="<?= url('views/security/visitors/delete.php?id=' . urlencode($id)) ?>">Delete record</a>
                    </div>
                </div>
            </div>
        </div>
