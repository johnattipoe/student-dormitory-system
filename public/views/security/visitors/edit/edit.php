...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    redirect(url('views/security/visitors/view/view.php?id=' . urlencode($id)));
}
...
<div class="main-content security-portal">
    ...
    <div class="content-wrapper">
        <section class="security-hero mb-4">
            ...
            <a class="btn btn-light" href="<?= url('views/security/visitors/view/view.php?id=' . urlencode($id)) ?>">
                ...
                <div class="security-card">
                    ...
                    <form method="POST" class="row g-3">
                        ...
                        <div class="col-12 d-flex flex-wrap gap-2">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= url('views/security/visitors/view/view.php?id=' . urlencode($id)) ?>">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
