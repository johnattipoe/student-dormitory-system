...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'import_visitors' && !empty($_FILES['visitors_file'])) {
    ...
    if ($file['error'] !== UPLOAD_ERR_OK || !in_array($extension, ['csv', 'xlsx'], true)) {
        ...
        try {
            ...
            redirect(url('views/security/visitors/bulk-import/bulk-import.php'));
        } catch (Throwable $e) {
...
$navItems = [
    ...
    ['icon' => 'bi-upload', 'label' => 'Import Visitors', 'href' => url('views/security/visitors/bulk-import/bulk-import.php'), 'active' => true],
];
...
<div class="main-content security-portal">
    ...
    <div class="content-wrapper">
        <section class="security-hero mb-4">
            ...
            <a class="btn btn-light" href="<?= url('views/security/visitors/bulk-import/bulk-import.php?download_template=1') ?>">
                ...
                <section class="security-card">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="col-12 d-flex flex-wrap gap-2">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= url('views/security/visitors/visitors/visitors.php') ?>">Back to visitors</a>
                        </div>
                    </form>
                </section>
            </div>
