...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($result['success']) {
            ...
            redirect(url('views/security/profile/security/security.php'));
        } else {
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div>
                <h5 class="mb-1">Security Officer Account Security</h5>
                <p class="text-muted mb-0">Update login password and view active terminal session info.</p>
            </div>
        ...
        <div class="row g-4" style="max-width: 900px;">
            ...
            <div class="col-md-5">
                <div class="card stat-card p-4">
                    <h6 class="fw-bold mb-3"><i class="bi bi-shield-lock me-2 text-primary"></i> Gate Post Session</h6>
                    <div class="mb-3 pb-2 border-bottom">
                        <span class="text-muted small d-block">Officer UID</span>
