...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($result['success']) {
            ...
            redirect(url('views/security/profile/index.php'));
        } else {
...
$officeRoomVal = $_POST['officeRoom'] ?? $user['officeRoom'] ?? 'Main Gate Security Post';
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div>
                <h5 class="mb-1">Edit Security Officer Profile</h5>
                <p class="text-muted mb-0">Update your officer contact details and guard station assignment.</p>
            </div>
            <a class="btn btn-outline-secondary btn-sm" href="<?= url('views/security/profile/index.php') ?>">
        ...
        <div class="card stat-card p-4" style="max-width: 750px;">
            <form method="POST" class="row g-3">
                <div class="col-md-6">
                    <label class="form-label fw-bold" for="name">Officer Full Name <span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    <label class="form-label fw-bold" for="altPhone">Duty Walkie / Alt Phone</label>
                    <input class="form-control" id="altPhone" name="altPhone" value="<?= e($altPhoneVal) ?>" placeholder="e.g. +233 20 000 0000">
                </div>

                <div class="col-md-12">
                    <label class="form-label fw-bold" for="officeRoom">Guard Post / Station</label>
                    <input class="form-control" id="officeRoom" name="officeRoom" value="<?= e($officeRoomVal) ?>" placeholder="e.g. Main Gate Security Post">
                </div>

                <div class="col-12">
                    <label class="form-label fw-bold" for="bio">Duty Profile & Notes</label>
                    <textarea class="form-control" id="bio" name="bio" rows="3"><?= e($bioVal) ?></textarea>
                </div>

                <div class="col-12 d-flex justify-content-end gap-2 mt-4">
                    <a class="btn btn-outline-secondary" href="<?= url('views/security/profile/index.php') ?>">Cancel</a>
