...
$navItems = [
    ...
    ['icon' => 'bi-gear', 'label' => 'Settings', 'href' => url('views/nurse/settings/index.php')],
    ['icon' => 'bi-person-vcard', 'label' => 'Account Overview', 'href' => url('views/nurse/settings/account/index.php'), 'active' => true],
];
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div><h5 class="mb-1"><i class="bi bi-person-vcard me-2 text-primary"></i>Account Overview</h5><p class="text-muted mb-0">Review and update your Nurse account details.</p></div>
            <a href="<?= url('views/nurse/settings/index.php') ?>" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i>Settings</a>
        </div>
        <div class="card stat-card p-4" style="max-width:800px;">
            <form method="POST" data-ts-profile-form>
                ...
                <div class="mb-3"><label class="form-label fw-semibold">Role</label><input class="form-control" value="Nurse" readonly></div>
