...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($result['success']) {
            flash('success', 'Administrator password has been updated.');
            redirect(url('views/admin/profile/security/security.php'));
        } else {
...
$pageTitle = 'Security & Credentials';
$navItems = [
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div>
                <h5 class="mb-1">Administrator Security & Credentials</h5>
                <p class="text-muted mb-0">Manage superuser password and monitor active sessions.</p>
            </div>
        ...
        <div class="row g-4" style="max-width: 900px;">
            <div class="col-md-7">
                <div class="card stat-card p-4">
                    <h6 class="fw-bold mb-3"><i class="bi bi-key me-2 text-primary"></i> Change Admin Password</h6>
                    <form method="POST">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <?php endif; ?>
                            <div class="form-text small">Minimum 6 characters with mixed symbols recommended.</div>
                        </div>
                        <div class="mb-3">
            ...
            <div class="col-md-5">
                <div class="card stat-card p-4">
                    <h6 class="fw-bold mb-3"><i class="bi bi-shield-lock me-2 text-primary"></i> Superuser Session Forensics</h6>
                    <div class="mb-3 pb-2 border-bottom">
                        <span class="text-muted small d-block">Admin UID</span>
                    ...
                    <div class="mb-3 pb-2 border-bottom">
                        <span class="text-muted small d-block">Authorization Matrix</span>
                        <span class="badge bg-danger">Full Superuser (All Permissions)</span>
                    </div>
                    <div>
