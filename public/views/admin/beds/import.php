...
$navItems = [
    ...
    ['icon' => 'bi-grid-3x3-gap', 'label' => 'Beds', 'href' => url('views/admin/beds/index.php')],
    ['icon' => 'bi-upload', 'label' => 'Import Beds', 'href' => url('views/admin/beds/import.php'), 'active' => true],
];
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="card stat-card p-4" style="max-width: 760px;">
            <div class="d-flex justify-content-between align-items-center mb-3"><h5 class="mb-0">Import Beds</h5><a class="btn btn-outline-secondary btn-sm" href="<?= url('views/admin/beds/index.php') ?>">Back</a></div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <a class="btn btn-outline-secondary" href="<?= url('views/admin/beds/import.php?download_template=1') ?>">Download template</a>
            </form>
        </div>
    </div>
</div>
