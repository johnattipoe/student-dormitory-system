...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $_SESSION['_old'] = $data;
    redirect(url('views/visitors/request/request.php'));
}

$navItems = [
    ['icon' => 'bi-speedometer2', 'label' => 'Dashboard', 'href' => url('views/student/dashboard/index.php')],
    ['icon' => 'bi-person-badge', 'label' => 'Visitor Request', 'href' => url('views/visitors/request/request.php'), 'active' => true],
];
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="card stat-card p-4" style="max-width:720px">
            ...
            <form method="POST" action="<?= url('views/visitors/request/request.php') ?>">
                <div class="row g-3">
                    <div class="col-md-6">
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <a href="<?= url('views/student/visitors/index/index.php') ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
