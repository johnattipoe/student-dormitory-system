...
$allowedRoles = [ROLE_SECURITY, ROLE_SENIOR_HOUSEPARENT];
...
$navItems = [
    ...
    ['icon' => 'bi-person-badge', 'label' => 'Register Visitor', 'href' => url('views/visitors/register/register.php'), 'active' => true],
];
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="card stat-card p-4" style="max-width:720px">
            ...
            <form method="POST" action="<?= url('views/visitors/register/register.php') ?>">
                <div class="row g-3">
                    <div class="col-md-6">
