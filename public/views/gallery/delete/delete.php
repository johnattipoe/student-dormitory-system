...
if ($fileName === '' || !is_file($imagePath) || !is_array($metadata)) {
    ...
    <div class="content-wrapper">
        <div class="card border-0 shadow-sm mx-auto" style="max-width: 640px;">
            <div class="card-body p-4">
                ...
                <img src="<?= e(url('uploads/student-gallery/' . rawurlencode($fileName))) ?>" alt="<?= e($metadata['studentName'] ?? 'Student photo') ?>" class="img-fluid rounded mb-4" style="max-height: 360px; object-fit: contain;">
