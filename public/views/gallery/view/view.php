    ...
    <div class="content-wrapper">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center p-4">
                <img src="<?= e(url('uploads/student-gallery/' . rawurlencode($fileName))) ?>" alt="<?= e($metadata['studentName'] ?? 'Student photo') ?>" class="img-fluid rounded" style="max-height: 70vh; object-fit: contain;">
