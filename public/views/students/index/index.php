            ...
            <table class="table table-hover data-table w-100">
                ...
                <?php foreach ($students as $student): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('views/admin/students/view/view.php?id=' . urlencode($student['id'] ?? '')) ?>" class="btn btn-sm btn-outline-secondary"><i class="bi bi-eye"></i></a>
                            <?php if (current_role() !== ROLE_STUDENT): ?>
                                <a href="<?= url('views/admin/students/edit/edit.php?id=' . urlencode($student['id'] ?? '')) ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
