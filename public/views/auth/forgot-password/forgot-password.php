...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/favicon.ico?v=mawuli-school-3">
    <link rel="icon" type="image/png" href="/favicon.png?v=mawuli-school-3">
    <link rel="shortcut icon" type="image/x-icon" href="/favicon.ico?v=mawuli-school-3">
...
<body class="login-body d-flex align-items-center justify-content-center">
    <div class="login-card card shadow-lg border-0">
        <div class="card-body p-4">
            ...
            <form method="POST" action="/index.php?route=/views/auth/forgot-password/forgot-password.php">
                <div class="mb-3">
