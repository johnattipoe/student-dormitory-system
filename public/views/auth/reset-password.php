...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($token)) {
        ...
        redirect(base_url('views/auth/reset-password.php'));
    }

    if (strlen($password) < 8) {
        flash('error', 'Password must be at least 8 characters long.');
        redirect(base_url('views/auth/reset-password.php?token=' . urlencode($token)));
    }
...
<body class="login-body d-flex align-items-center justify-content-center">
    <div class="login-card card shadow-lg border-0">
        <div class="card-body p-4">
            ...
            <form method="POST" action="/index.php?route=/views/auth/reset-password.php">
