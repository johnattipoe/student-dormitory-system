...
$filename = 'house-master-' . preg_replace('/[^a-z0-9_-]+/i', '-', $type) . '-' . date('Y-m-d') . '.csv';
...
if ($type === 'attendance') {
    ...
    // Default high level house master summary export
    ...
    fputcsv($output, ['Total Dormitory Rooms', $roomStats['rooms'] ?? 0]);
