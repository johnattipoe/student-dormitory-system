...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($result['success']) {
            ...
            redirect(url('views/house-master/profile/security/security.php'));
        } else {
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div>
                <h5 class="mb-1"><?= e($roleTitle) ?> Account Security</h5>
                <p class="text-muted mb-0">Update credentials, manage your password, and view active session details.</p>
            </div>
        ...
        <div class="row g-4" style="max-width: 900px;">
            ...
            <div class="col-md-5">
                <div class="card stat-card p-4">
                    <h6 class="fw-bold mb-3"><i class="bi bi-shield-lock me-2 text-primary"></i> Session Audit & Forensics</h6>
                    <div class="mb-3 pb-2 border-bottom">
                        <span class="text-muted small d-block">Account UID</span>
                        <span class="font-monospace small"><?= e($userId) ?></span>
                    </div>
                    <div class="mb-3 pb-2 border-bottom">
                        <span class="text-muted small d-block">Login IP Address</span>
                    ...
                    <div class="mb-3 pb-2 border-bottom">
                        ...
                        <span class="small text-muted text-truncate d-block"><?= e(mb_strimwidth($_SERVER['HTTP_USER_AGENT'] ?? 'Standard Browser', 0, 45, '...')) ?></span>
                    </div>
                    <div>
                        <span class="text-muted small d-block">Authentication Status</span>
