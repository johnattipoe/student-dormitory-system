                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="10" class="text-center text-muted py-4">No students found registered under your house.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
