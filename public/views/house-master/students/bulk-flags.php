    ...
    if ($action === 'bulk_flag' && !empty($studentIds)) {
        ...
        if (!$flagType) {
            ...
            try {
                ...
                redirect(url('views/house-master/students/bulk-flags.php'));
            } catch (Exception $e) {
    ...
    <div class="content-wrapper">
        ...
        <div class="mb-3">
            <div class="btn-group" role="group">
                <a href="<?= url('views/house-master/students/bulk-flags.php') ?>" class="btn btn-outline-primary btn-sm <?= $filterType === 'all' ? 'active' : '' ?>">
                    All (<?= count($students) ?>)
                </a>
                <a href="<?= url('views/house-master/students/bulk-flags.php?type=flagged') ?>" class="btn btn-outline-warning btn-sm <?= $filterType === 'flagged' ? 'active' : '' ?>">
                    Flagged (<?= count($flaggedStudents) ?>)
                </a>
                <a href="<?= url('views/house-master/students/bulk-flags.php?type=unflagged') ?>" class="btn btn-outline-success btn-sm <?= $filterType === 'unflagged' ? 'active' : '' ?>">
