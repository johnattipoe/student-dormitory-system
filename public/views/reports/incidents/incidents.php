...
$navItems = [
    ...
    ['icon' => 'bi-exclamation-triangle', 'label' => 'Incident Report', 'href' => url('views/reports/incidents/incidents.php'), 'active' => true],
];
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        ...
        <?php $reportType = 'incidents'; require APP_ROOT . '/app/views/components/report-downloads/report-downloads.php'; ?>
