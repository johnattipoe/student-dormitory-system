...
$navItems = [
    ...
    ['icon' => 'bi-person-badge', 'label' => 'Visitor Report', 'href' => url('views/reports/visitors/visitors.php'), 'active' => true],
];
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        ...
        <?php $reportType = 'visitors'; require APP_ROOT . '/app/views/components/report-downloads/report-downloads.php'; ?>
