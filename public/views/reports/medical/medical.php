...
$navItems = [
    ...
    ['icon' => 'bi-heart-pulse', 'label' => 'Medical Report', 'href' => url('views/reports/medical/medical.php'), 'active' => true],
];
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        ...
        <?php $reportType = 'medical'; require APP_ROOT . '/app/views/components/report-downloads/report-downloads.php'; ?>
