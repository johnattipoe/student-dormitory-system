...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="card stat-card p-4">
            ...
            <div class="row g-3">
                <div class="col-md-6"><strong>Room:</strong> <?= e($room['roomNumber'] ?? '—') ?></div>
                <div class="col-md-6"><strong>Block:</strong> <?= e($room['block'] ?? '—') ?></div>
                <div class="col-md-6"><strong>Capacity:</strong> <?= e($room['capacity'] ?? '—') ?></div>
                <div class="col-md-6"><strong>Occupancy:</strong> <?= e($room['occupancy'] ?? '0') ?></div>
            </div>
        </div>
    </div>
</div>
