...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($result['success']) {
            ...
            redirect(url('views/student/profile/security/security.php'));
        } else {
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div>
                <h5 class="mb-1">Student Account Security</h5>
                <p class="text-muted mb-0">Manage password and view your login session info.</p>
            </div>
            <a class="btn btn-outline-secondary btn-sm" href="<?= url('views/student/profile/index/index.php') ?>">
        ...
        <div class="row g-4" style="max-width: 900px;">
                ...
                <div class="card stat-card p-4">
                    ...
                    <form method="POST">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a class="btn btn-outline-secondary" href="<?= url('views/student/profile/index/index.php') ?>">Cancel</a>
            ...
            <div class="col-md-5">
                <div class="card stat-card p-4">
                    <h6 class="fw-bold mb-3"><i class="bi bi-shield-lock me-2 text-primary"></i> Current Session</h6>
                    <div class="mb-2">
