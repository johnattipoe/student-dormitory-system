    ...
    <div class="content-wrapper">
        <section class="student-settings-hero mb-4">
            ...
            <div class="student-settings-actions">
                <a href="<?= url('views/student/profile/edit.php') ?>" class="btn btn-light"><i class="bi bi-pencil-square me-1"></i>Edit Profile</a>
                <a href="<?= url('views/student/settings/notification-preferences.php') ?>" class="btn btn-primary"><i class="bi bi-sliders me-1"></i>Notifications</a>
            </div>
        </section>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <article class="student-settings-card h-100">
                            ...
                            <a href="<?= url('views/student/settings/notification-preferences.php') ?>" class="btn btn-outline-primary mt-auto"><i class="bi bi-sliders me-1"></i>Manage notifications</a>
                        </article>
                    </div>
                    ...
                    <div class="col-md-6">
                        <article class="student-settings-card h-100">
                            ...
                            <a href="<?= url('views/student/profile/edit.php') ?>" class="btn btn-outline-primary mt-auto"><i class="bi bi-pencil me-1"></i>Edit contact details</a>
                        </article>
                    </div>
                    ...
                    <div class="col-md-6">
                        <article class="student-settings-card h-100">
                            ...
                            <div class="student-settings-button-grid">
                                <a href="<?= url('views/student/visitors/index.php') ?>" class="btn btn-outline-info"><i class="bi bi-list-check me-1"></i>Visitor log</a>
                                <a href="<?= url('views/visitors/request.php') ?>" class="btn btn-outline-primary"><i class="bi bi-person-plus me-1"></i>New request</a>
                            </div>
                        </article>
                    </div>
                </div>
            ...
            <div class="col-xl-4">
                <aside class="student-settings-side-panel">
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?= url('views/student/notifications/index.php') ?>" class="btn btn-outline-primary"><i class="bi bi-bell me-1"></i>Open notifications</a>
                        <a href="<?= url('views/student/attendance/index.php') ?>" class="btn btn-outline-success"><i class="bi bi-calendar-check me-1"></i>Attendance records</a>
                        <a href="<?= url('views/student/incidents/index.php') ?>" class="btn btn-outline-danger"><i class="bi bi-flag me-1"></i>Incident records</a>
