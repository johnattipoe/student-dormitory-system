...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'update_preferences') {
        try {
            ...
            redirect(url('views/student/settings/notification-preferences/notification-preferences.php'));
        } catch (Exception $e) {
...
$navItems = [
    ...
    ['icon' => 'bi-bell', 'label' => 'Notifications', 'href' => url('views/student/settings/notification-preferences/notification-preferences.php'), 'active' => true],
];
        ...
        <div class="card stat-card p-4" style="max-width: 700px;">
            ...
            <form method="POST">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?= url('views/student/settings/index/index.php') ?>" class="btn btn-outline-secondary">
                        Cancel
                    </a>
                </div>
            </form>
