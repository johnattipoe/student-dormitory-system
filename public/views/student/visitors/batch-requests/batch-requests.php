        ...
        if (empty($visitors)) {
            ...
            try {
                ...
                if ($successCount > 0) {
                    ...
                    redirect(url('views/student/visitors/batch-requests/batch-requests.php'));
                } else {
...
$navItems = [
    ...
    ['icon' => 'bi-plus-circle', 'label' => 'Batch Requests', 'href' => url('views/student/visitors/batch-requests/batch-requests.php'), 'active' => true],
];
