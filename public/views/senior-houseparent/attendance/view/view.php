...
if (!$entry) {
    ...
    redirect(url('views/senior-houseparent/attendance/index/index.php'));
}
    ...
    <div class="content-wrapper">
        <div class="card stat-card p-4" style="max-width: 650px;">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a class="btn btn-outline-secondary btn-sm" href="<?= url('views/senior-houseparent/attendance/index/index.php') ?>">Back</a>
            </div>
            <dl class="row mt-3">
                <dt class="col-sm-3">Student</dt>
                <dd class="col-sm-9"><strong><?= e($studentName) ?></strong></dd>
                ...
                <dd class="col-sm-9"><?= e($markedByName) ?></dd>
            </dl>
        </div>
    </div>
</div>
