...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2"><div><div class="text-muted small text-uppercase fw-semibold">Student welfare</div><h5 class="mb-1">Medical Records</h5><p class="text-muted mb-0">Medical information for students in your house.</p></div><span class="badge bg-primary"><i class="bi bi-heart-pulse me-1"></i><?= e((string) $totalRecords) ?> records</span></div>
        ...
        </tbody></table></div><?php $paginationBaseUrl = url('views/senior-houseparent/medical/index/index.php'); require APP_ROOT . '/app/views/components/pagination/pagination.php'; ?></div>
    </div>
</div>
