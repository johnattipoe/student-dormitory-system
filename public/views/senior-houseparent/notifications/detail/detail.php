...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'mark_read') {
    ...
    redirect(base_url('index.php?route=/views/senior-houseparent/notifications/detail/detail.php&id=' . urlencode($notificationId)));
}
...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <a href="<?= e(url('views/senior-houseparent/notifications/index/index.php')) ?>" class="small text-decoration-none">
        ...
        <article class="card stat-card p-4">
            ...
            <div>
                <a href="<?= e(url('views/senior-houseparent/notifications/index/index.php')) ?>" class="btn btn-primary btn-sm">
