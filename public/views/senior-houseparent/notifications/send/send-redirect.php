...
redirect(url('views/senior-houseparent/notifications/send/send.php'));
...
$navItems = [
    ...
    ['icon' => 'bi-send', 'label' => 'Send Notification', 'href' => url('views/senior-houseparent/notifications/send/send.php'), 'active' => true],
];
    ...
    <div class="content-wrapper">
        <div class="card stat-card p-4" style="max-width:760px">
            ...
            <form method="POST">
                ...
                <div class="mt-4"><button class="btn btn-primary"><i class="bi bi-send me-1" aria-hidden="true"></i> Send notification</button> <a class="btn btn-outline-secondary" href="<?= url('views/senior-houseparent/notifications/index/index.php') ?>">Cancel</a></div>
            </form>
        </div>
    </div>
</div>
