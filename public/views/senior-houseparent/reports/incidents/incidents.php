    ...
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <div>
                ...
                <p class="text-muted mb-0">Overview of disciplinary records and behavioral reports.</p>
            </div>
            <div class="d-flex gap-2">
                <a class="btn btn-outline-success btn-sm" href="<?= url('views/senior-houseparent/reports/export/export.php?type=incidents') ?>">
        ...
        <div class="card stat-card p-3">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a class="btn btn-sm btn-primary" href="<?= url('views/senior-houseparent/incidents/index/index.php') ?>">
                    <i class="bi bi-shield-exclamation me-1"></i> Manage Incidents
                </a>
            </div>
                        ...
                        <?php else: ?>
                            <?php foreach ($incidents as $incident): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#seniorReportIncident-<?= e((string) ($incident['id'] ?? '')) ?>">
