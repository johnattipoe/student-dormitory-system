                        ...
                        <?php else: ?>
                            <?php foreach ($visitors as $visitor): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#seniorReportVisitor-<?= e((string) ($visitor['id'] ?? '')) ?>">
