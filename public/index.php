...
$defaultRoleRoutes = [
    ...
    '/views/admin/dashboard/' => '/views/admin/dashboard.php',
    '/views/admin/dashboard.php' => '/views/admin/dashboard.php',
    '/views/admin/finance' => '/views/admin/finance/index/index.php',
    '/views/admin/finance/' => '/views/admin/finance/index/index.php',
    '/views/admin/finance/index.php' => '/views/admin/finance/index/index.php',
    ...
    '/views/house-master/dashboard/' => '/views/house-master/dashboard/index.php',
    '/views/house-master/profile' => '/views/house-master/profile/index.php',
    '/views/house-master/profile/' => '/views/house-master/profile/index.php',
    '/views/house-master/profile.php' => '/views/house-master/profile/index.php',
    ...
    '/views/senior-houseparent/dashboard/' => '/views/senior-houseparent/dashboard/index.php',
    '/views/senior-houseparent/profile' => '/views/senior-houseparent/profile/index.php',
    '/views/senior-houseparent/profile/' => '/views/senior-houseparent/profile/index.php',
    '/views/senior-houseparent/profile.php' => '/views/senior-houseparent/profile/index.php',
    '/views/security' => '/views/security/dashboard/dashboard.php',
    '/views/security/' => '/views/security/dashboard/dashboard.php',
    '/views/security/dashboard' => '/views/security/dashboard/dashboard.php',
    '/views/security/dashboard/' => '/views/security/dashboard/dashboard.php',
    '/views/security/profile' => '/views/security/profile/index.php',
    '/views/security/profile/' => '/views/security/profile/index.php',
    '/views/security/profile.php' => '/views/security/profile/index.php',
    '/views/nurse' => '/views/nurse/dashboard/dashboard.php',
    '/views/nurse/' => '/views/nurse/dashboard/dashboard.php',
    '/views/nurse/dashboard' => '/views/nurse/dashboard/dashboard.php',
    '/views/nurse/dashboard/' => '/views/nurse/dashboard/dashboard.php',
    '/views/nurse/profile' => '/views/nurse/profile/index.php',
    '/views/nurse/profile/' => '/views/nurse/profile/index.php',
    '/views/nurse/profile.php' => '/views/nurse/profile/index.php',
    '/views/student' => '/views/student/dashboard/index.php',
    '/views/student/' => '/views/student/dashboard/index.php',
    '/views/student/dashboard' => '/views/student/dashboard/index.php',
    '/views/student/dashboard/' => '/views/student/dashboard/index.php',
    '/views/student/profile' => '/views/student/profile/index/index.php',
    '/views/student/profile/' => '/views/student/profile/index/index.php',
    '/views/student/profile.php' => '/views/student/profile/index/index.php',
